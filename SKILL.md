...
**Author**: Donald Asher | **Chapters**: 9 + Introduction | **Generated**: 2026-05-26
...
### The Application Sequence (Asher's Order)
Never write before doing Chapter 5. The sequence is rigid:
1. Build a 20+ school list nationally (Ch 2)
...
- Wrong school name
- All activities are brand new (red flag for padding)
- Praises program without naming specific faculty
- Claims of altruism not backed by evidence elsewhere in application
...
2. PhD is often cheaper than master's (PhD candidates better funded)
3. Full time is often cheaper than part time (compounding salary boost)
4. Always apply for aid even if wealthy (merit fellowships = academic credentials)
...
### Three-Tier Admissions Model
Admissions officers sort into: (1) definite admits, (2) maybes, (3) rejects. Under rolling admissions, the admit tier fills first. Late applicants compete for shrinking maybe slots. One dean's honest answer about late applications: "We cash the checks."
...
|---|-------|----------------|
| [Intro](chapters/ch00-introduction.md) | How to Use This Book | Read-First Write-Second Protocol, Procrastination Recovery Sequence |
| [Ch 1](chapters/ch01-should-you-go.md) | Should You Go to Grad School? | Good Reasons vs. Warning Signs, Funding Counterintuitions, Bailout Master's Trap |
| [Ch 2](chapters/ch02-choosing-school.md) | Choosing a School or Program | 20-School Rule, 5-Dimension Evaluation, Department vs. Institution Rule, Law of Descending Prestige |
| [Ch 3](chapters/ch03-planning-process.md) | Planning and Managing Your Application | Activity Log, 30-Day-Early Rule, Three-Tier Admissions Model, Verification Protocol |
| [Ch 4](chapters/ch04-what-happens.md) | What Happens to Your Application | Strong Department vs. Strong Graduate School Model, Dual-Format Submission Rule |
| [Ch 5](chapters/ch05-getting-ready.md) | Getting Ready to Write | Pool-Building Protocol, Unusual Self-Assessment, Career Epiphany Reconstruction |
| [Ch 6](chapters/ch06-first-draft.md) | Your First Draft | RTGDQ, Write-First Phase, Epiphany Opening, School-Specific Demonstration |
| [Ch 7](chapters/ch07-subsequent-drafts.md) | Subsequent Drafts | The Academizer, Sitting in the Reader's Brain, Essay Hall of Shame, Weaknesses-as-Strengths |
| [Ch 8](chapters/ch08-samples.md) | Samples, Samples, Samples | Personal + Academic Combination, Anti-Modeling Warning, Style Spectrum |
| [Ch 9](chapters/ch09-letters-of-rec.md) | Letters of Recommendation | Three-Criteria Selection, Rights Waiver Rule, Better Letters Handout, Extra Letter Protocol |
